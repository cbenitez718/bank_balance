// Chapter 6 Learning How and When to Use a do…while Loop (Page 306 - 307)
...
public class BankBalance2
{
	public static void main(String[] args) 
	{
		...
		do 
		{
			...
			System.out.println("After year " + year + " at " + INT_RATE + " interest rate, balance is $" + roundBal);
			year = year + 1;
		...
		System.out.println("\nExiting programm have a great day!");
